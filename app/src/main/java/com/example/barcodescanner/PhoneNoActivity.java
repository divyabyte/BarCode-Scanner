...
public class PhoneNoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = findViewById(R.id.arrowPhoneNo);
        done = findViewById(R.id.donePhoneNo);
        textValue = findViewById(R.id.phoneValue);
        ...
        //
            ...
            public void onClick(View view) {
                ...
                if(strUserName.matches("")) {
                    ...
                    Intent i = new Intent(PhoneNoActivity.this, SplashWaitActivity.class);
